...
?>
            ...
            <div class="fixed w-screen z-10">
                <header class="w-screen flex justify-between items-center pt-4 sm:py-4 bg-white dark:bg-[#232228] pr-16 sm:pr-36 rounded-lg">
                    <div class="flex items-center gap-4">
                        ...
                        <h1 class="hidden sm:block text-4xl font-bold dark:text-white"><?php echo ucfirst(basename($_SERVER['PHP_SELF'], ".php")); ?></h1>
                    </div>
                    ...
                    <div class="flex items-center text-4xl text-gray-800 gap-4">
                        ...
                        <div class="flex items-center gap-8">
                            <!-- Notification Icon -->
                            <div class="relative">
                                <a href="user-notifications.php" class="text-3xl sm:text-4xl hover:text-gray-600 dark:text-gray-300 dark:hover:text-white transition duration-300">
                            ...
                            <!-- Chat Icon -->
                            <div class="relative">
                                <a href="user-support-chat.php" class="text-3xl sm:text-4xl hover:text-gray-600 dark:text-gray-300 dark:hover:text-white transition duration-300">
    ...
    <script>
    function checkUserUnreadMessages() {
        let xhr = new XMLHttpRequest();
        xhr.open("POST", "../../supportChat/php/check-user-unread.php", true);
        xhr.onload = () => {
    ...
    // Check every second
    setInterval(checkUserUnreadMessages, 1000);
    ...
    function checkUserNotifications() {
        let xhr = new XMLHttpRequest();
        xhr.open("POST", "../../backend/check-notification-count.php", true);
        xhr.onload = () => {
            if (xhr.readyState === XMLHttpRequest.DONE && xhr.status === 200) {
                try {
                    const data = JSON.parse(xhr.response);
