            ...
            <section class="flex flex-col sm:flex-row w-full gap-8 pt-16 h-full">
                ...
                <div class="w-full sm:w-2/3 bg-white dark:bg-[#1b1a20] rounded-xl p-8 shadow-lg">
                    <div class="text-center mb-8">
                        ...
                        <h2 class="text-2xl sm:text-3xl font-bold mb-4">Deposit Rejected</h2>
                        <p class="text-gray-600 dark:text-gray-400 mb-2">The deposit has been rejected</p>
                    </div>
                    ...
                    <div class="bg-gray-50 dark:bg-[#161618] rounded-xl p-6 mb-8">
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <p class="w-24 bg-red-400 p-0.5 rounded-lg text-center dark:text-gray-950"><?php echo $depositData['status']; ?></p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="hidden sm:block w-1/3 space-y-6">
                    <div class="bg-red-100 dark:bg-red-900 p-6 rounded-xl">
                        <h3 class="text-lg font-bold mb-4">Deposit Rejected</h3>
                        <ul class="space-y-2 text-sm">
                            <li>• Deposit has been rejected</li>
                            <li>• User will be notified</li>
                            <li>• Status updated to Rejected</li>
                            <li>• No balance changes made</li>
                        </ul>
                    </div>
