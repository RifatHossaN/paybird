            ...
            <section class="flex flex-col sm:flex-row w-full gap-8 pt-16 h-full">
                ...
                <div class="w-full sm:w-2/3 bg-white dark:bg-[#1b1a20] rounded-xl p-8 shadow-lg">
                    <div class="text-center mb-8">
                        ...
                        <h2 class="text-2xl sm:text-3xl font-bold mb-4">Transaction Accepted Successfully!</h2>
                        <p class="text-gray-600 dark:text-gray-400 mb-2">The transaction has been processed and accepted</p>
                    </div>
                    ...
                    <div class="bg-gray-50 dark:bg-[#161618] rounded-xl p-6 mb-8">
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <p class="w-24 bg-green-400 p-0.5 rounded-lg text-center dark:text-gray-950"><?php echo $transData['status']; ?></p>
                            </div>
                            <div>
                                <p class="text-sm text-gray-500 dark:text-gray-400">Last Number/PIN</p>
                                <p class="font-semibold"><?php echo $transData['lastnumber']; ?></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex gap-4 mt-6">
                        ...
                        <a href="admin-pending-transactions.php" 
                ...
                <div class="hidden sm:block w-1/3 space-y-6">
                    <div class="bg-green-100 dark:bg-green-900 p-6 rounded-xl">
                        <h3 class="text-lg font-bold mb-4">Transaction Accepted</h3>
                        <ul class="space-y-2 text-sm">
                            <li>• Transaction has been processed</li>
                            <li>• User will be notified</li>
                            <li>• Details have been recorded</li>
                            <li>• Status updated to Accepted</li>
                        </ul>
                    </div>
